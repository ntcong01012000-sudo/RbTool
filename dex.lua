...
local function main()
	...
	Lib.Window = (function()
		...
		local theme = {
			MainColor1 = Color3.fromRGB(24,25,33),
			MainColor2 = Color3.fromRGB(18,19,26),
	...
	Lib.Checkbox = (function()
		...
		local function new(style)
			local obj = setmetatable({
				...
				Style = style or 0,
				Colors = {
					Background = c3(28,29,37),
					Primary = c3(100,108,255),
					Secondary = c3(18,19,26),
					Disabled = c3(60,62,74),
					DisabledBackground = c3(24,25,33),
...
DefaultSettings = (function()
	...
	return {
		...
		Theme = {
			...
			Main1 = rgb(24,25,33),
			Main2 = rgb(18,19,26),
			Outline1 = rgb(45,47,57), -- Mainly frames
			Outline2 = rgb(55,57,68), -- Mainly button
			Outline3 = rgb(30,32,42), -- Mainly textbox
			TextBox = rgb(28,29,37),
			Menu = rgb(30,31,41),
			ListSelection = rgb(100,108,255),
			Button = rgb(38,40,50),
			ButtonHover = rgb(50,53,65),
			ButtonPress = rgb(28,29,37),
			Highlight = rgb(100,108,255),
			Text = rgb(240,240,245),
			PlaceholderText = rgb(130,135,150),
			Important = rgb(235,75,75),
			ExplorerIconMap = "",
			MiscIconMap = "",
			Syntax = {
				Text = rgb(240,240,245),
				...
				Error = rgb(255,85,85),
				FindBackground = rgb(241,250,140),
				MatchingWord = rgb(68,71,90),
				BuiltIn = rgb(139,233,253),
				CurrentLine = rgb(40,42,54),
				LocalMethod = rgb(80,250,123),
				LocalProperty = rgb(139,233,253),
				Nil = rgb(189,147,249),
				Bool = rgb(189,147,249),
				Function = rgb(80,250,123),
				Local = rgb(255,121,198),
				Self = rgb(255,121,198),
				FunctionName = rgb(80,250,123),
...
print("==============================================")
print("       DARK DEX VIP EDITION BY ANTIGRAVITY    ")
print("==============================================")
print("- Theme: Premium Dracula & Neon Slate Indigo")
print("- Status: Adonis Bypass Active")
print("==============================================")
